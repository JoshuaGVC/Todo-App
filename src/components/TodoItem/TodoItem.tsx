    ...
    return (
        ...
        >
            <div className="todo__list__itext">
                ...
                <label
                    htmlFor={`item-${index}`}
                    className="todo__list__ilabel"
                >
                    {title}
                </label>
            </div>
            <div className="todo__list__ioptions">
                <button onClick={() => action('edit')} className="todo__list__iedit">Edit</button>
                <button onClick={() => action('delete')} className="todo__list__iremove">Delete</button>
            </div>
        </li>
    )
}
